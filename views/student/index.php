  ...
  <table class="table">
    ...
    foreach ($dataProvider as $index => $data) {
        ...
        <tr id="refresh-<?=$data->id?>">
          ...
          <td>
            <img src="<?=$data->profile_pic?>" width="100" height="100">
          </td>
          <td>
...
<div class="site-login">
 ...
 <form id="w0" action="#" >
    ...
    ?>
        ...
        <input type="text" id="user-username" class="form-control login-username" name="User[username]" required="required">

        </div>

<div class="form-group">
 <label for="">Password</label>
		<input type="password" id="user-password" class="form-control login-password" name="User[password]" required="required">
...
<div class="site-register">
    <h1><?=Html::encode('Register Form')?></h1>
 <form id="w0" action="#" >
    <p>Register Form</p>
    ...
    ?>
		<div class="form-group">
                <label for="">Username</label>
        <input type="text" id="user-username" class="form-control register-username" name="User[username]" required="required">

        </div>

<div class="form-group">
 <label for="">Password</label>
		<input type="password" id="user-password" class="form-control register-password" name="User[password]" required="required">

</div>

        <div class="form-group">
            <div class="offset-lg-1 col-lg-11">
                <?=Html::submitButton('Register', ['class' => 'btn btn-primary btn-register','name' => 'login-button'])?>
            </div>
        </div>
</form>
...
$(".btn-register").click(function() {
	...
	$.ajax({
	    url: '<?=Url::toRoute(['student/register'])?>',
	    data: {
...
function uploadFile(fname){
  ...
  $.ajax({
    url: '<?=Url::toRoute(['student/upload-file'])?>?fName='+fname+'&id='+id,
    type: 'post',
    data: fd,
    contentType: false,
    processData: false,
...
$(".btn-save").click(function() {
  ...
  var profilePic = uploadFile(name,id);
